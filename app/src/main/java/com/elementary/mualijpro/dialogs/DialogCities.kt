...
import com.elementary.mualijpro.adapters.CitiesAdapter
...
class DialogCities(
    citiesArray: ArrayList<Cities>,
    private var cityCallBack: CityCallBack
) : DialogFragment() {


    private var citiesArray = ArrayList<Cities>()
    var lvCities: ListView? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, parent: ViewGroup?, state: Bundle?): View? {
        ...
        val view = activity!!.layoutInflater.inflate(R.layout.dialog_cities, parent, false)
        viewInitialize(view)
        setListeners()
        setData()
        return view
    ...
    private fun setData() {
        adapter = CitiesAdapter(cityCallBack, mContext!!, citiesArray)
